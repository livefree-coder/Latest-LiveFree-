...
const ServicesOverview: React.FC = () => {
  ...
  return (
    <section id="services-section" className="relative py-20" style={{ backgroundColor: '#1e293b' }}>
      <div className="absolute inset-0" style={{ backgroundColor: '#1e293b', zIndex: 0 }}></div>
